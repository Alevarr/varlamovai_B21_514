...
balanced_threshold("input/Screenshot_3.bmp", f"{output_dir}/Screenshot.bmp")
save_inverted_image(f"{output_dir}/Screenshot.bmp", f"{inverse_output_dir}/Screenshot_inverse.bmp")
